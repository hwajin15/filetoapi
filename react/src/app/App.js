...
import SearchBar from '../data/SerchBar';
          ...
          <Content className="app-content">
            <div className="container">
              ...
              <Route exact path="/" >
                ...
                <PrivateRoute authenticated={this.state.isAuthenticated} path="/upload" component={Upload} handleLogout={this.handleLogout}></PrivateRoute>
